# Basic step-by-step inlining example
...
Functions from dependencies (stdlib) are loaded as LazyIr.
...
//
inline fun run(block: Function0<Int>) : Unit {
...
//         IrInlinedFunctionBlock debug information menaning offsets inside are relative to lib.kt
//            IrReturn 
//               target=symbol1
//               value = IrCall 

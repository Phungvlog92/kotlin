...
class NativeConflictingOverloadsDispatcher : ConflictingOverloadsDispatcher {
    private val default = ConflictingOverloadsDispatcher.Default()
    override fun getDiagnostic(
        ...
        return default.getDiagnostic(declaration, redeclarations)
    }
}